...
const Footer = () => {
  return (
    <footer id="footer" className="bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-8 lg:mb-0 text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start space-x-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-lg"><img src={logo} alt="logo" className="p-1"/></span>
              </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center">
          <p className="text-gray-400 text-sm">
            ...
            <a href="#" className="hover:text-purple-300 ml-2">Privacy Policy</a> | 
            <a href="#" className="hover:text-purple-300 ml-2">Terms of Service</a>
          </p>
        </div>
      </div>
    </footer>
