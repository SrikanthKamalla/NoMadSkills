...
const DataAnalytics = () => {
  ...
  return (
    <>
      {/* ✅ Helmet for SEO + Verification */}
      <Helmet>
        <title>Data Analytics with AI Course | Launch Your Tech Career</title>
        <meta
          name="description"
          content="Join our Data Analytics with AI course. Master data visualization, SQL, Python, and business analytics. Learn from top industry experts and get job-ready!"
        />
        <meta
          name="keywords"
          content="Data Analytics course, AI data analytics, data visualization, Python, SQL, business analytics training, career in data analytics"
        />
        <meta
          name="google-site-verification"
          content="j4ORLKZP8m5CDbROLwqodTxsLkdw2gpTAZQF_gz0Xgs"
        />
        <link rel="canonical" href="https://www.yourdomain.com/data-analytics" />
      </Helmet>
