...
import { School, GraduationCap, Users, Award, Layers, BookOpen, Briefcase, X } from "lucide-react";
...
const Institutions = () => {
  ...
  const features = [
    ...
    { icon: <Briefcase className="w-5 h-5 text-blue-600" />, text: "Customizable courses" },
    {
      ...
      text: "Beyond classroom approach",
    },
  ...
  return (
    <>
      {/* ✅ Helmet SEO + Google Verification */}
      <Helmet>
        <title>Institution Partnerships | Nomadskills for Schools & Colleges</title>
        <meta
          name="description"
          content="Partner with Nomadskills to bring hands-on coding, design, and career readiness programs to your school or college. Transform your curriculum with real-world skill development."
        />
        <meta
          name="keywords"
          content="Nomadskills institutions, school coding program, college tech partnerships, educational collaborations, upskilling, live sessions, coding for students"
        />
        <meta
          name="google-site-verification"
          content="j4ORLKZP8m5CDbROLwqodTxsLkdw2gpTAZQF_gz0Xgs"
        />
        <link rel="canonical" href="https://www.yourdomain.com/institutions" />
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide comprehensive educational packages customized to the needs of your
              institution. Our <strong>Skillcamp Courses</strong> together with{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                skills like coding, communication, design thinking, and more — delivered in an
                engaging, project-based format.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                Give your students an edge in the competitive job market with specialized Skill
                Camps and courses created in collaboration with industry experts. We offer flexible
