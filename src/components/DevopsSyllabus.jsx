            ...
            <div className="grid md:grid-cols-2 gap-4 text-left">
              ...
              >
                ...
                <span className="text-sm sm:text-base">
                  AWS Certified DevOps Engineer - Professional Ready
                </span>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
              ...
              >
                ...
                <span className="text-sm sm:text-base">Master AWS Cloud & DevOps Tools</span>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <span className="text-sm sm:text-base">
                  Build CI/CD, Containers & IaC Expertise
                </span>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
              ...
              >
                ...
                <span className="text-sm sm:text-base">Automate with Ansible & DevSecOps</span>
              </motion.div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {tools.map((tool, index) => (
              <motion.span
                ...
                whileHover={{ scale: 1.05 }}
                className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 px-4 py-2 rounded-full font-medium border border-blue-200 text-sm sm:text-base"
              >
                {tool}
              </motion.span>
            ))}
