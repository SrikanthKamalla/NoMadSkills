...
import { Shield, Lock, Mail, Globe, User, AlertTriangle, Book, GraduationCap, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 pt-20 pb-10">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center py-20">
          ...
          >
            At Nomadskills @ Schools & Colleges, we are committed to protecting the privacy 
            and security of students, educators, and institutional data.
          </motion.p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                and educators use our comprehensive educational packages including Skillcamp Courses 
                and Skillarena Competitions.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 space-y-2 text-gray-700">
                ...
                <li>
                  <strong>Mentoring Data:</strong> Records from one-on-one mentoring sessions 
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                settings and we work closely with schools and parents to ensure compliant 
                data handling for all age groups.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                When facilitating industry collaboration, we share only anonymized or 
                aggregated student performance data unless explicit consent is obtained 
                for specific internship or mentorship opportunities.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Institutions will be notified of significant changes and provided with 
                updated documentation for their records.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                For questions about this Privacy Policy or our educational data practices, 
                please contact our Educational Data Protection Officer at{" "}
                <a
