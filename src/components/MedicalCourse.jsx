...
import MedicalCodingSyllabus from "./MedicalCodingSyllabus";
    ...
    try {
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          ...
          link.href = "/Medical Coding Program (With CPC Certification).pdf";
          link.download = "Medical Coding Program (With CPC Certification).pdf";
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:image" content="https://www.yourdomain.com/mern-preview.jpg" />
        <link rel="canonical" href="https://www.yourdomain.com/merncourse" />
        <meta
        ...
        <div className="relative z-10 container mx-auto px-4 py-8">
          ...
          >
            ...
            >
              ...
              >
                Download Curriculum
                <a href="/Medical Coding Program (With CPC Certification).pdf" download />
              </motion.button>
            </motion.header>
            ...
            >
              <div className="p-6">
                ...
                <p className="text-gray-500 text-sm mt-4 text-center">
                  We'll send the Medical Coding syllabus to your download folder
                </p>
              </div>
            </motion.div>
          </div>
