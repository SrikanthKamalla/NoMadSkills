              ...
              {step.courses.map((course, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-gray-700 text-base mb-4 leading-relaxed">{course.description}</p>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((tech, i) => (
                      <span key={i} className="px-3 py-1 bg-purple-50 text-purple-700 rounded-full text-sm font-medium border border-purple-200">
                        {tech}
                      </span>
                    ))}
                  </div>
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 text-lg">
                  Structured path to success in tech
                </p>
              </div>
                      ...
                      >
                        ...
                        >
                          <div className="flex items-start justify-between">
                            ...
                            {index <= activeStep && (
                              <CheckCircle className={`w-5 h-5 ${index === activeStep ? 'text-blue-500' : 'text-green-500'} flex-shrink-0 mt-1`} />
                            )}
                          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div className="p-4 bg-white rounded-xl border border-blue-200 shadow-sm">
                    ...
                    <div className="text-xs text-gray-600">Professionals Network</div>
