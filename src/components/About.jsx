...
export default function AboutUs() {
  return (
    <>
      <Helmet>
        <title>About Us | NomadSkills - Empowering Future-Ready Learners</title>
        <meta
          name="description"
          content="Learn about NomadSkills — an edtech platform by Laxion Pvt. Ltd. empowering students and professionals with hands-on, industry-driven courses and skill camps."
        />
        <meta
          name="keywords"
          content="About NomadSkills, Laxion Pvt Ltd, edtech India, online learning, skill development, career growth, education platform"
        />
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://www.nomadskills.in/about" />

        {/* Open Graph Tags for Social Media */}
        <meta
          property="og:title"
          content="About Us | NomadSkills - Empowering Future-Ready Learners"
        />
        <meta
          property="og:description"
          content="Discover the story of NomadSkills — bridging the gap between academia and industry through practical skill education."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.nomadskills.in/about" />
        <meta property="og:image" content="https://www.nomadskills.in/assets/about-og-image.webp" />
        ...
        <meta
          ...
          content="NomadSkills is dedicated to transforming education through innovative, skill-based learning experiences."
        />
        <meta
          name="twitter:image"
          content="https://www.nomadskills.in/assets/about-og-image.webp"
        />
          ...
          {`
    {
      ...
      "description": "NomadSkills empowers learners with skill-based education and industry-ready programs.",
      "sameAs": [
        "https://www.facebook.com/nomadskills",
        "https://www.linkedin.com/company/nomadskills",
        "https://twitter.com/nomadskills"
      ]
    }
    `}
        </script>
      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-cyan-50 text-gray-800">
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          >
            At <span className="font-semibold text-blue-600">NomadSkills</span>, we strive to bridge
            the gap between academia and the industry — providing skill education and training on
        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed text-center max-w-3xl mx-auto">
              Our mission is to impart affordable and top-notch skill camps and courses, both
              offline and online, cultivating academic excellence and essential practical skills for
              your journey to success. We are not just an ed-tech company — we are{" "}
        ...
        <div className="bg-gradient-to-r from-blue-300 to-cyan-400 text-white text-center py-16 mt-12">
          ...
          >
            Step into a world where learning meets innovation. Let’s build the future of skills —
            together.
          </motion.p>
          <motion.a
            href="/"
